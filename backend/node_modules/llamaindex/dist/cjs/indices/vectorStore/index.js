...
class VectorStoreIndex extends _BaseIndex.BaseIndex {
    ...
    constructor(init){
        ...
        this.embedModel = (0, _Settings.embedModelFromSettingsOrContext)(init.serviceContext);
        this.imageVectorStore = init.imageVectorStore ?? init.storageContext.imageVectorStore;
        if (this.imageVectorStore) {
            this.imageEmbedModel = new _ClipEmbedding.ClipEmbedding();
        }
    }
    /**
   ...
   */ async getNodeEmbeddingResults(nodes, options) {
        ...
        if (imageNodes.length > 0) {
            if (!this.imageEmbedModel) {
                throw new Error("Cannot calculate image nodes embedding without 'imageEmbedModel' set");
            }
   ...
   */ static async fromDocuments(documents, args = {}) {
        ...
        (args.vectorStore ? _index.DocStoreStrategy.UPSERTS : _index.DocStoreStrategy.DUPLICATES_ONLY);
        ...
        const docStoreStrategy = (0, _index.createDocStoreStrategy)(args.docStoreStrategy, docStore, args.vectorStore);
...
class VectorIndexRetriever {
    ...
    sendEvent(query, nodesWithScores) {
