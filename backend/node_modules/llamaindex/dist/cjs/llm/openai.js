...
var _initProto;
class AzureOpenAI extends _openai.OpenAI {
    authHeaders() {
        return {
            "api-key": this.apiKey
        };
...
class OpenAI extends _base.ToolCallLLM {
    static{
    ...
    constructor(init){
        ...
        if (init?.azure || (0, _azure.shouldUseAzure)()) {
            const azureConfig = (0, _azure.getAzureConfigFromEnv)({
                ...init?.azure,
            ...
            this.session = init?.session ?? getOpenAISession({
                azure: true,
                apiKey: this.apiKey,
                baseURL: (0, _azure.getAzureBaseUrl)(azureConfig),
    ...
    get metadata() {
        ...
        return {
            ...
            contextWindow,
            tokenizer: _GlobalsHelper.Tokenizers.CL100K_BASE
        };
    }
    ...
    async *streamChat(baseRequestParams) {
        ...
        for await (const part of stream){
            ...
            (0, _CallbackManager.getCallbackManager)().dispatchEvent("stream", {
                index: idxCounter++,
                isDone: isDone,
                token: part
            });
