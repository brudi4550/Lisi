...
import type { ChatMessage, ChatResponse, ChatResponseChunk, LLM, MessageContent } from "../llm/types.js";
...
export type TaskStep<Model extends LLM = LLM, Store extends object = {}, AdditionalMessageOptions extends object = Model extends LLM<object, infer AdditionalMessageOptions> ? AdditionalMessageOptions : never> = {
    id: UUID;
