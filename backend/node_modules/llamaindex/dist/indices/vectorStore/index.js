...
import { Settings, embedModelFromSettingsOrContext, nodeParserFromSettingsOrContext } from "../../Settings.js";
 ...
 */ export class VectorStoreIndex extends BaseIndex {
   ...
   */ static async fromDocuments(documents, args = {}) {
        ...
        (args.vectorStore ? DocStoreStrategy.UPSERTS : DocStoreStrategy.DUPLICATES_ONLY);
        ...
        const docStoreStrategy = createDocStoreStrategy(args.docStoreStrategy, docStore, args.vectorStore);
